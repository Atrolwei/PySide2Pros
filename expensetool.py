...
from PySide2.QtWidgets import QApplication,QMainWindow,QAction,QLineEdit,QPushButton, QTableWidgetItem, QTreeWidgetItem, QVBoxLayout,QWidget,QTableWidget,QHeaderView,QHBoxLayout,QVBoxLayout,QLabel,QHeaderView
...
class Widget(QWidget):
    def __init__(self):
        ...
        # Temporary disable the add button
